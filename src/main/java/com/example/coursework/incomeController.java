...
public class incomeController implements Initializable {
    ...
    private String[] incomeOptions = {"Salary", "Deposit", "Savings", "Freelance", "Trading",  "Other"};

    @Override
    public void initialize(URL arg0, ResourceBundle arg1){

        incomeChoiceBox.getItems().addAll(incomeOptions);
        incomeChoiceBox.getSelectionModel().select(0);
    ...
    void onAddEntryBtnClick(ActionEvent event) throws SQLException, IOException {
        ...
        String type = "Income";
        String category = incomeChoiceBox.getValue();
